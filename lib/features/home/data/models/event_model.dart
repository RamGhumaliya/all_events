class EventsModelResponse {
  Request? request;
  int? count;
  List<EventModel>? item;

  EventsModelResponse({this.request, this.count, this.item});

  EventsModelResponse.fromJson(Map<String, dynamic> json) {
    request =
    ...
    if (json['item'] != null) {
      item = <EventModel>[];
      json['item'].forEach((v) {
        item!.add(EventModel.fromJson(v));
      });
    }
  }
